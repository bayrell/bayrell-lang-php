...
class OpChilds extends BaseOpCode{
	 ...
	 * Constructor
	 */
	function __construct($childs = null){
		parent::__construct();
		$this->childs = $childs;
	}
	/**
	...
	public function getClassName(){return "BayrellLang.OpCodes.OpChilds";}
	public static function getCurrentClassName(){return "BayrellLang.OpCodes.OpChilds";}
	...
	public function assignValue($variable_name, $value, $sender = null){
		if ($variable_name == "op")$this->op = rtl::convert($value,"string","op_childs","");
