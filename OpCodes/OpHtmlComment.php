...
class OpHtmlComment extends OpValue1{
	...
	public static function getCurrentClassName(){return "BayrellLang.OpCodes.OpHtmlComment";}
	...
	public function assignValue($variable_name, $value, $sender = null){
		if ($variable_name == "op")$this->op = rtl::convert($value,"string","op_html_comment","");
