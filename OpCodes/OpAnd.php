...
class OpAnd extends OpValue2{
	...
	public function getClassName(){return "BayrellLang.OpCodes.OpAnd";}
	public static function getCurrentNamespace(){return "BayrellLang.OpCodes";}
	public static function getCurrentClassName(){return "BayrellLang.OpCodes.OpAnd";}
	...
	public function assignValue($variable_name, $value, $sender = null){
		if ($variable_name == "op")$this->op = rtl::convert($value,"string","op_and","");
